...
namespace Babadzaki.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if(!await _roleManager.RoleExistsAsync(WebConstants.AdminRole))//если роль админа создана
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(User.IsInRole(WebConstants.AdminRole))//new
                    {
