...
namespace Babadzaki.Controllers
{
    ...
    public class OldTokenManagementController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly ILogger<OldTokenManagementController> _logger;
        private readonly IMapper _mapper;

        public OldTokenManagementController(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, ILogger<OldTokenManagementController> logger, IMapper mapper)
        { 
